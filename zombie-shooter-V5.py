...
def menu_screen():
    global high_score, level3_unlocked
    player_name = ""
    input_active = False
    ...
    level1_button = pygame.Rect(WIDTH//2 - 100, HEIGHT//2 - 40, 200, 50)
    level2_button = pygame.Rect(WIDTH//2 - 100, HEIGHT//2 + 20, 200, 50)
    level3_button = pygame.Rect(WIDTH//2 - 100, HEIGHT//2 + 80, 200, 50)
...
def main():
    global god_mode, noclip, level3_unlocked
